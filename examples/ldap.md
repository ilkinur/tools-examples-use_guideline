...
`ldapsearch -x -H ldap://<Target IP Address> -b "DC=htb,DC=local" "objectclass=*"`  
...
`ldapsearch -H ldap://<Target IP Address> -x -b "DC=htb,DC=local" '(objectClass= Employee) ' sAMAccountName sAMAccountType`  
